    ...
    <div class="signin-card">
      <div class="login-card">
        ...
        <form class="login-form">
          ...
          <h5>Do not have an account? <button type="button" class="toggle-form" onclick="toggleForm()">Sign Up now</button></h5>
        </form>
      </div>
    </div>
        ...
        <div class="form-outer">
          <form class="login-form" action="process_signup.php" method="post">
            <div class="page slide-page">
              ...
              <h5 class="already-account">Already have an account? <button type="button" class="toggle-form" onclick="toggleForm()">Login now</button></h5>
